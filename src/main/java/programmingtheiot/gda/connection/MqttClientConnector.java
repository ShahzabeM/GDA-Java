...
public class MqttClientConnector implements IPubSubClient, MqttCallbackExtended
{
	...
	{
	    if (reconnect) {
	        _Logger.info("Reconnected to MQTT broker: " + serverURI);
	    } else {
	...
	{
	    _Logger.warning("Connection to MQTT broker lost. Reconnecting...");
	}
		
	@Override
	public void deliveryComplete(IMqttDeliveryToken token)
	{
	    _Logger.info("Message delivery complete: " + token);
	}
		
	@Override
	public void messageArrived(String topic, MqttMessage msg) throws Exception
	{
	    _Logger.info("Message received on topic " + topic + ": " + new String(msg.getPayload()));
	}
