...
public class DeviceDataManagerSimpleCdaActuationTest {
	// static
		...
		public void testSendActuationEventsToCda()
		{
			...
			float nominalVal = 40.0f; //cfgUtil.getFloat(ConfigConst.GATEWAY_DEVICE,   "nominalHumiditySetting");
			float lowVal     = 30.0f;//cfgUtil.getFloat(ConfigConst.GATEWAY_DEVICE,   "triggerHumidifierFloor");
			float highVal    = 50.0f;//cfgUtil.getFloat(ConfigConst.GATEWAY_DEVICE,   "triggerHumidifierCeiling");
			int   delay      = 10;//cfgUtil.getInteger(ConfigConst.GATEWAY_DEVICE, "humidityMaxTimePastThreshold");
